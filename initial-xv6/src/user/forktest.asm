...
forktest(void)
{
  ...
  68:	43450513          	addi	a0,a0,1076 # 498 <waitx+0x5c>
  ...
  8a:	3d250513          	addi	a0,a0,978 # 458 <waitx+0x1c>
  ...
  a4:	3d050513          	addi	a0,a0,976 # 470 <waitx+0x34>
  ...
  e4:	3a850513          	addi	a0,a0,936 # 488 <waitx+0x4c>
